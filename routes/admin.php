...
Route::group(['prefix' => '/admin'], function () {
  ...
  Route::group(['middleware' => 'auth:admin'], function () {
      ...
      // 删除标签
      Route::delete('/tags/{id}','\App\Admin\Controllers\TagsController@destroy') ->name('admin.tags.destroy');
  
      // 资源推荐
      Route::resource('/links','\App\Admin\Controllers\LinksController');

      // 友情链接
      Route::resource('/friends','\App\Admin\Controllers\FriendsController');
  });
});
