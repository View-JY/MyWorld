...
<form action="/admin/friends" method="post" enctype="multipart/form-data">
	...
	<div class="row">
		<div class="col-xs-4">
			...
			<input type="file" id="input-file-now-custom-2" class="dropify" data-height="100" data-width="80" name="logo" data-default-file=""/>
		</div>
	...
	<div class="form-group">
	    ...
	    <input type="text" class="form-control" name="link" id="link" placeholder="链接地址">
	</div>
